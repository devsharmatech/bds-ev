              ...
              <div className="px-3 md:px-6 py-3 md:py-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                  <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs md:text-sm text-gray-600">
                        {event?.joined
                          ? "Your spot is confirmed! Check details below."
                          : `${event?.capacity
                  ...
                  <div className="flex items-center justify-between md:justify-end gap-2 md:gap-3">
                    ...
                    {/* Join/View Button */}
                    {!event?.joined && onJoinClick && derivedStatus === "upcoming" && (
                      <button
                        onClick={() => {
                          onClose();
                          onJoinClick(event);
                        }}
                        className="px-4 py-2 md:px-6 md:py-2 bg-gradient-to-r from-[#03215F] to-[#03215F] text-white rounded-lg font-semibold hover:opacity-90 transition-opacity active:scale-95 flex items-center gap-2 text-sm md:text-base"
                      >
                        Join Now
            ...
            <div className="flex-1 overflow-y-auto p-3 sm:p-4 md:p-6" style={{ WebkitOverflowScrolling: "touch" }}>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
                      <div className="flex items-center gap-2 md:gap-3 p-2 md:p-3 bg-gradient-to-r from-[#9cc2ed] to-[#9cc2ed] rounded-lg">
                        <CertificateIcon className="w-4 h-4 md:w-5 md:h-5 text-[#03215F] flex-shrink-0" />
                                ...
                                <div className="flex flex-col md:flex-row md:items-start justify-between gap-1 md:gap-0">
                                  ...
                                  {agenda.speaker && (
                                    <div className="flex items-center gap-1 md:gap-2 px-2 py-1 bg-gray-100 rounded-full self-start">
                                      <UserCircle className="w-3 h-3 md:w-4 md:h-4 text-gray-500 flex-shrink-0" />
              ...
              {activeTab === "hosts" && (
                <div className="space-y-4 md:space-y-6">
                  <div className="flex items-center justify-between mb-3 md:mb-4">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 flex items-center gap-2">
                      <TeamIcon className="w-4 h-4 md:w-5 md:h-5 text-[#03215F]" />
                            ...
                            <div className="relative flex-shrink-0">
                              {host.profile_image ? (
                                ...
                                <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-[#9cc2ed] to-[#9cc2ed] border-2 border-white flex items-center justify-center shadow-lg">
                                  <UserCircle className="w-6 h-6 md:w-8 md:h-8 text-[#03215F]" />
                                </div>
                              )}
                              {host.is_primary && (
              ...
              {/* My Ticket Tab (for joined users) */}
              {activeTab === "myticket" && event?.joined && (
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-gray-50 to-white rounded-xl p-4 md:p-6 text-center">
                      ...
                      <div className="mt-3 md:mt-4 flex flex-col sm:flex-row justify-center gap-2">
                        <button
                          ...
                          className="px-4 py-2 text-sm font-semibold rounded-lg bg-black text-white hover:bg-gray-800 transition active:scale-95"
                        >
                          Download QR
                        </button>
                      </div>
                  ...
                  <div className="bg-gradient-to-r from-[#9cc2ed] to-[#9cc2ed] rounded-xl p-3 md:p-5">
                    <h4 className="font-semibold text-sm md:text-base text-gray-900 mb-2 md:mb-3 flex items-center gap-2">
                      <Info className="w-4 h-4 md:w-5 md:h-5 text-[#03215F]" />
                      Ticket Instructions
                    </h4>
                ...
                <div className="flex items-center justify-center md:justify-end gap-2 md:gap-3">
                  ...
                  {!event?.joined && onJoinClick && derivedStatus === "upcoming" && (
                    <button
                      ...
                      className="px-3 py-1.5 md:px-6 md:py-2 bg-gradient-to-r from-[#03215F] to-[#03215F] text-white rounded-lg font-semibold hover:opacity-90 transition-opacity active:scale-95 text-sm md:text-base flex-1 md:flex-none"
                    >
                      Join Event
                    </button>
                  )}
