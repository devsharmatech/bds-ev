  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent transition-all duration-200"
      />
    </label>
  );
}
  ...
  return (
    <label className="block">
      ...
      <textarea
        ...
        rows={rows}
        placeholder={placeholder}
        className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent transition-all duration-200 resize-vertical textarea-scrollbar overflow-y-auto"
      />
    </label>
  );
}
  ...
  return (
    <label className="block">
      ...
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="w-full p-3 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent transition-all duration-200"
      >
        {options.map((option) => (
...
export function QuestionForm({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto">
      <form
        onSubmit={submit}
        className="space-y-6 bg-white rounded-2xl p-8 shadow-xl border border-gray-200"
      >
        ...
        <div className="space-y-6">
          ...
          {/* Question Image URL */}
          <div>
            <div className="text-sm font-medium mb-2 text-gray-700 flex items-center gap-2">
              <Image size={16} />
              Question Image URL
            </div>
            <input
        ...
        <div className="flex justify-end gap-3 pt-6 border-t border-gray-200">
          ...
          <button
            type="submit"
            disabled={saving}
            className="px-6 py-3 bg-gradient-to-r from-[#AE9B66] to-[#AE9B66] text-white rounded-xl hover:from-[#AE9B66] hover:to-[#AE9B66] transition-all duration-200 font-medium flex items-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed min-w-[140px] justify-center"
          >
            {saving ? (
              <>
      ...
      >
        ...
        <div className="flex justify-end gap-3 pt-4">
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-[#03215F] to-[#03215F] text-white rounded-xl hover:from-[#03215F] hover:to-[#03215F] transition-all duration-200 font-medium flex items-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px] justify-center"
          >
            {saving ? (
              <>
                <Loader2 className="animate-spin" size={20} />
        ...
        {/* Help text */}
        <div className="bg-[#9cc2ed] border border-[#9cc2ed] rounded-lg p-4">
