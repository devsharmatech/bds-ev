...
export async function GET(request) {
  ...
  // Return a simple HTML page with payment status data
  // The mobile app should intercept this URL or read the page content
