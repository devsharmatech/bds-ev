        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#AE9B66] rounded-lg">
                  <Eye className="w-6 h-6 text-[#AE9B66]" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#9cc2ed] rounded-lg">
                  <MessageSquare className="w-6 h-6 text-[#03215F]" />
                </div>
                <div>
                ...
                <div className="p-5">
                  <div className="flex items-start gap-4">
                    <div className="relative">
                      <div className="w-20 h-20 rounded-xl overflow-hidden bg-gradient-to-br from-[#9cc2ed] to-[#9cc2ed]">
                  ...
                  {testimonials.map((testimonial) => (
                    <tr key={testimonial.id} className="hover:bg-gray-50 transition-colors">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-12 h-12 rounded-lg overflow-hidden bg-gradient-to-br from-[#9cc2ed] to-[#9cc2ed]">
                            {testimonial.profile_image ? (
                              <img 
                                src={testimonial.profile_image} 
                                alt={testimonial.name}
              ...
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-1">
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 text-center hover:border-[#9cc2ed] transition-colors">
                      <input
                        type="file"
                        accept="image/*"
                      ...
                      >
                        {form.preview ? (
                          ...
                          <>
                            <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#9cc2ed] to-[#9cc2ed] flex items-center justify-center">
                  ...
                  <div className="md:col-span-2 space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none transition-all resize-none"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                        <div className="flex items-center gap-3">
                          <div className={`p-2 rounded-full ${form.status ? 'bg-[#AE9B66]' : 'bg-gray-200'}`}>
                            {form.status ? (
                              <Eye className="w-5 h-5 text-[#AE9B66]" />
                            ) : (
        ...
        {showDeleteConfirm && toDelete && (
          ...
          >
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="bg-white rounded-2xl w-full max-w-md shadow-2xl border border-gray-200 p-6"
            >
              ...
              <div className="flex justify-center gap-3">
                <motion.button
                  ...
                  className="px-6 py-3 rounded-xl border border-gray-300 font-medium hover:bg-gray-50 transition-colors flex-1"
                >
                  Cancel
                </motion.button>
                <motion.button
                  ...
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#b8352d] to-[#b8352d] text-white font-medium flex-1"
                >
                  Delete
                </motion.button>
              </div>
