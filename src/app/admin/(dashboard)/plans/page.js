    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
      ...
      <div className="mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
              ...
              <div className="relative flex-1 sm:flex-none">
                ...
                <input
                  ...
                  className="w-full sm:w-64 pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none transition-all"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="px-3 py-2.5 rounded-xl border border-gray-300 bg-white text-gray-900 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none"
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={openCreate}
                  className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#03215F] to-[#03215F] text-white font-semibold flex items-center gap-2 shadow-lg hover:shadow-xl transition-all"
                >
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#ECCF0F] rounded-lg">
                  <Star className="w-6 h-6 text-[#ECCF0F]" />
                </div>
                <div>
                  <p className="text-sm text-gray-500">Popular</p>
                  <p className="text-2xl font-bold mt-1">{popularPlans}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#03215F] rounded-lg">
                  <Gift className="w-6 h-6 text-[#03215F]" />
                </div>
                <div>
                  <p className="text-sm text-gray-500">With Trial</p>
                  <p className="text-2xl font-bold mt-1">{trialPlans}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center py-16 bg-white rounded-2xl shadow-lg border border-gray-200">
            ...
            {!search && !courseFilter && (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={openCreate}
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#03215F] to-[#03215F] text-white font-semibold"
              >
                Create First Plan
              </motion.button>
            )}
              ...
              return (
                <motion.div
                  ...
                  className={`bg-white rounded-2xl overflow-hidden border ${
                    plan.popular 
                      ? 'border-[#ECCF0F] shadow-lg shadow-[#ECCF0F]' 
                      : 'border-gray-200'
                  } shadow-lg hover:shadow-xl transition-all duration-300 group`}
                >
                  {plan.popular && (
                    <div className="bg-gradient-to-r from-[#ECCF0F] to-[#ECCF0F] text-white px-4 py-1.5 text-xs font-semibold text-center">
                      <Star className="w-3 h-3 inline mr-1" /> POPULAR CHOICE
                    </div>
                  )}

                  {plan.offer_active && plan.discount_price && (
                    <div className="bg-gradient-to-r from-[#b8352d] to-[#b8352d] text-white px-4 py-1.5 text-xs font-semibold text-center">
                      ...
                      <div className="flex items-baseline gap-2">
                        ...
                        {plan.original_price && plan.original_price > plan.price && (
                          <>
                            ...
                            <span className="px-2 py-0.5 bg-[#b8352d] text-white text-xs font-semibold rounded">
                              {discountPercent}% OFF
                            </span>
                          </>
                        )}
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {plan.access_features?.videos && (
                          <span className="px-2 py-1 bg-[#9cc2ed] text-[#03215F] text-xs rounded-lg flex items-center gap-1">
                        ...
                        {plan.access_features?.tests && (
                          <span className="px-2 py-1 bg-[#03215F] text-white text-xs rounded-lg flex items-center gap-1">
                            <CheckCircle className="w-3 h-3" /> Tests
                          </span>
                        )}
                        {plan.ai_access && (
                          <span className="px-2 py-1 bg-[#b8352d] text-white text-xs rounded-lg flex items-center gap-1">
                      ...
                      {plan.features_list?.slice(0, 3).map((feature, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm">
                          <CheckCircle className="w-4 h-4 text-[#9cc2ed]" />
                      ...
                      <tr key={plan.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <div className="space-y-1">
                            ...
                            {plan.supports_addons && (
                              <div className="text-xs text-[#03215F]">
                                Add-ons available
                              </div>
                            )}
                          </div>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-col gap-1">
                            ...
                            {plan.popular && (
                              <span className="px-2 py-0.5 bg-[#ECCF0F] text-[#03215F] text-xs font-medium rounded">
                                Popular
                              </span>
                            )}
                          </div>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-2">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              onClick={() => openEdit(plan)}
                              className="p-2 rounded-lg bg-[#9cc2ed] text-[#03215F] hover:bg-[#9cc2ed] transition-colors"
                              title="Edit plan"
                            >
                              <Edit3 className="w-4 h-4" />
                            </motion.button>
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              onClick={() => handleDelete(plan)}
                              className="p-2 rounded-lg bg-[#b8352d] text-white hover:bg-[#b8352d] transition-colors"
                              title="Delete plan"
                            >
                              <Trash2 className="w-4 h-4" />
                            </motion.button>
        ...
        {plans.length > 0 && totalPages > 1 && (
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 p-6 bg-white rounded-2xl shadow border border-gray-200">
            ...
            <div className="flex items-center gap-2">
              <motion.button
                ...
                disabled={page === 1}
                className="px-4 py-2.5 rounded-xl border border-gray-300 flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed hover:bg-gray-50 transition-colors"
              >
        ...
        <form onSubmit={handleCreate} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 bg-white focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none"
                required
                disabled={submitting}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-full ${form.offer_active ? 'bg-[#b8352d]' : 'bg-gray-200'}`}>
                  <Tag className="w-5 h-5 text-[#b8352d]" />
                </div>
                <div>
                  <p className="font-medium">Special Offer Active</p>
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  disabled={submitting}
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#b8352d] rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#b8352d]"></div>
              </label>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-3">
                {Object.entries(DEFAULT_FEATURES).map(([feature, defaultValue]) => {
                  ...
                  return (
                    <label
                      key={feature}
                      className="flex items-center justify-between p-3 border border-gray-300 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors"
                    >
                      <div className="flex items-center gap-3">
                        <Icon className="w-5 h-5 text-[#9cc2ed]" />
                        <div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <label className="flex items-center justify-between p-3 border border-gray-300 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors">
                  <div className="flex items-center gap-3">
                    <Settings className="w-5 h-5 text-[#9cc2ed]" />
                    <div>
                      <span className="font-medium">Supports Add-ons</span>
                      <p className="text-xs text-gray-500 mt-1">
                ...
                <label className="flex items-center justify-between p-3 border border-gray-300 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors">
                  <div className="flex items-center gap-3">
                    <HelpCircle className="w-5 h-5 text-[#03215F]" />
                    <div>
                ...
                <label className="flex items-center justify-between p-3 border border-gray-300 rounded-xl hover:bg-gray-50 cursor-pointer transition-colors">
                  <div className="flex items-center gap-3">
                    <Award className="w-5 h-5 text-[#ECCF0F]" />
                    <div>
          ...
          <div>
            ...
            <div className="flex gap-2 mb-3">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-xl border border-gray-300 bg-white focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none"
              ...
              <button
                ...
                className="px-4 py-3 rounded-xl bg-[#03215F] text-white disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Add
              </button>
            </div>
            <div className="flex flex-wrap gap-2">
              {form.features_list.map((feature, index) => (
                <span
                  key={index}
                  className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#9cc2ed] text-[#03215F] rounded-lg text-sm"
                >
                  {feature}
                  <button
                    type="button"
                    onClick={() => removeFeature(index)}
                    className="ml-1 text-[#03215F] hover:text-[#03215F]"
                    disabled={submitting}
                  >
                    ×
                  </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-full ${form.is_active ? 'bg-[#9cc2ed]' : 'bg-gray-200'}`}>
                  {form.is_active ? (
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  disabled={submitting}
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#03215F] rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#03215F]"></div>
              </label>
            </div>

            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-full ${form.auto_renew ? 'bg-[#9cc2ed]' : 'bg-gray-200'}`}>
                  <RefreshCw className={`w-5 h-5 ${form.auto_renew ? 'text-[#03215F]' : 'text-gray-500'}`} />
                </div>
                <div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
              <div className="flex items-center gap-3">
                <div className={`p-2 rounded-full ${form.popular ? 'bg-[#ECCF0F]' : 'bg-gray-200'}`}>
                  <Star className={`w-5 h-5 ${form.popular ? 'text-[#ECCF0F]' : 'text-gray-500'}`} />
                </div>
                <div>
                  <p className="font-medium">Popular Plan</p>
                  <p className="text-sm text-gray-500">
              ...
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  ...
                  disabled={submitting}
                />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[#ECCF0F] rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#ECCF0F]"></div>
              </label>
            </div>
          </div>
