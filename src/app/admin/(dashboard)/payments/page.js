...
const PAYMENT_STATUS = {
  success: { label: "Success", color: "bg-[#AE9B66] text-white", icon: CheckCircle },
  pending: { label: "Pending", color: "bg-[#ECCF0F] text-[#03215F]", icon: Clock },
  failed: { label: "Failed", color: "bg-[#b8352d] text-white", icon: XCircle },
  refunded: { label: "Refunded", color: "bg-[#9cc2ed] text-[#03215F]", icon: RefreshCw },
};

const PAYMENT_MODES = {
  razorpay: { label: "Razorpay", color: "bg-[#03215F] text-white", icon: Shield },
  stripe: { label: "Stripe", color: "bg-[#03215F] text-white", icon: CreditCard },
  cash: { label: "Cash", color: "bg-gray-100 text-gray-700", icon: DollarSign },
  bank_transfer: { label: "Bank Transfer", color: "bg-[#9cc2ed] text-[#03215F]", icon: TrendingUp },
};
            ...
            <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#ECCF0F] rounded-lg">
                  <Clock className="w-6 h-6 text-[#ECCF0F]" />
                </div>
                <div>
            ...
            <div className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold mt-1">{stats.failedPayments}</p>
                </div>
              </div>
            </div>
          </div>
