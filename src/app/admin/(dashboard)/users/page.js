...
export default function ManageUsersPage() {
  ...
  const RoleBadge = ({ role }) => {
    ...
    return (
      <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-medium ${role === 'admin' ? 'bg-[#b8352d] text-white' : role === 'doctor' ? 'bg-[#9cc2ed] text-[#03215F]' : 'bg-[#AE9B66] text-white'}`}>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <motion.button
                            ...
                            whileTap={{ scale: 0.9 }}
                            onClick={() => setShowPictureModal(true) || setPictureUser(user)}
                            className="p-2 rounded-lg bg-[#ECCF0F] text-[#03215F] hover:bg-[#ECCF0F] transition-colors"
                            title="Update photo"
                          >
                            <ImageIcon className="w-4 h-4" />
                          </motion.button>
          ...
          <div className="flex flex-col items-center gap-6">
            <div className="relative w-48 h-48 rounded-2xl overflow-hidden border-4 border-gray-200">
              {previewUrl || pictureUser?.profile_picture ? (
                ...
                <div className="w-full h-full bg-gradient-to-br from-[#9cc2ed] to-[#03215F] flex items-center justify-center">
            ...
            <div className="text-center">
              ...
              <label htmlFor="profilePictureInput">
                <div className="px-6 py-3 rounded-xl border-2 border-dashed border-gray-300 hover:border-[#9cc2ed] cursor-pointer transition-colors">
        ...
        <div className="text-center py-4">
          ...
          <div className="flex justify-center gap-3">
            <motion.button
              ...
              disabled={submitting}
              className="px-6 py-3 rounded-xl border border-gray-300 font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 flex-1"
            >
              Cancel
            </motion.button>
            <motion.button
