    ...
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
      {[...Array(6)].map((_, i) => (
        <div key={i} className="p-4 rounded-xl border bg-gray-50 animate-pulse">
          <div className="bg-gray-200 rounded-lg w-full h-48"></div>
      ...
      <div className=" mx-auto">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <motion.button
              ...
              className="group px-6 py-3 bg-gradient-to-r from-[#03215F] to-[#03215F] text-white rounded-xl flex items-center gap-3 shadow-lg hover:shadow-xl transition-all duration-200"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="bg-white rounded-xl p-4 shadow border border-gray-200">
              ...
              <p className="text-2xl font-bold text-[#AE9B66] mt-1">
                {banners.filter(b => b.status).length}
              </p>
            </div>
            <div className="bg-white rounded-xl p-4 shadow border border-gray-200">
              <p className="text-gray-600 text-sm">Page {pagination.currentPage}</p>
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-white rounded-2xl shadow-lg border border-gray-200">
            ...
            <button
              onClick={() => openForm(null)}
              className="px-6 py-3 bg-[#03215F] text-white rounded-xl font-semibold hover:bg-[#03215F] transition-colors"
            >
              Create First Banner
            </button>
          </div>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {banners.map((banner) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -20 }}
                  whileHover={{ y: -5 }}
                  className="group relative bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-300"
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-center gap-2 mb-3">
                      <LinkIcon className="w-4 h-4 text-[#9cc2ed]" />
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex gap-2">
                        <motion.button
                          ...
                          className="p-2.5 bg-[#9cc2ed] text-[#03215F] rounded-xl hover:bg-[#9cc2ed] transition-colors"
                          title="Edit banner"
                        >
                        ...
                        <motion.button
                          ...
                          className="p-2.5 bg-[#b8352d] text-white rounded-xl hover:bg-[#b8352d] transition-colors"
                          title="Delete banner"
                        >
            ...
            {pagination.totalPages > 1 && (
              <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-10 p-6 bg-white rounded-2xl shadow border border-gray-200">
        ...
        {showForm && (
          ...
          >
            <motion.div
              ...
              className="bg-white rounded-2xl w-full max-w-lg shadow-2xl border border-gray-200"
            >
              {/* Modal Header */}
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-[#9cc2ed] transition-colors">
                    <input
                      type="file"
                      accept="image/*"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3.5 rounded-xl border border-gray-300 bg-gray-50 focus:ring-2 focus:ring-[#9cc2ed] focus:border-transparent outline-none transition-all"
                    />
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div className="flex items-center gap-3">
                    <div className={`p-1 rounded-full ${form.status ? 'bg-[#AE9B66]' : 'bg-gray-200'}`}>
                      {form.status ? (
